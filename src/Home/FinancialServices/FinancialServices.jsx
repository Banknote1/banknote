...
function FinancialServices() {
    ...
    return (
        ...
        <div className={styles.section2} style={{ gap: '1.7%' }} >
            ...
            <div className={styles.leftCont}>
                ...
                <div className={styles.rightBottomCont}>
                    ...
                    <div className={styles.emptyBox} onClick={() => handleNavigation(3)}>
            ...
            <div className={styles.rightCont}>
                ...
                <div className={styles.rightTopCont}>
                    <div className={` ${styles.serBox}`} onClick={() => handleNavigation(1)}  >
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none">
